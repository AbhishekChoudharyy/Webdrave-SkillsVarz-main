    ...
    data-scroll-speed="0.1"  className="relative bg-black min-h-[240vh] py-[10vh] px-4 md:px-8">
      ...
      <div className="text-left mb-10">
          <div>
            ...
            <h2 className="text-4xl font-spacelight mt-2 leading-snug">A <span class='text-purple'> glimpse</span> into what we’ve built — websites, apps, and <br />
             <span class='text-purple'>experiences</span> that <span class='text-purple'>speak</span> for themselves.
            </h2>
          </div>
        </div>
        </Magnet>
        ...
        {cards.map((card, i) => (
          ...
          >
            ...
            <div className="flex-1 flex flex-col justify-center space-y-5 text-white">
              <span className="inline-block border border-white/30 px-8 py-4 text-sm font-spacelight rounded-md w-fit">
                {card.tag}
              </span>
              <h2 className="text-7xl font-spacebold">{card.title}</h2>
              <p className="text-white/70 font-spacelight leading-relaxed">{card.description}</p>
              <button className="mt-4 w-fit px-6 py-3 bg-purple hover:shadow-[3px_3px_0_#ffffff] active:scale-[97%] active:shadow-[2px_2px_0_#ffffff] text-white text-sm font-spacelight rounded-md transition-shadow duration-300 ">
                Visit The Site
              </button>
            </div>
